...
namespace TPP.Laboratory.Functional.Lab05
{
    ...
    public class FunctionsTest
    {
        ...
        {
            Dictionary<string, int> peopleCountByName = people.Reduce<Person, Dictionary<string, int>>((acum, value) =>
            {
        ...
        {
            List<Person> peopleList = people.Reduce<Person, List<Person>>((acum, value) =>
            {
